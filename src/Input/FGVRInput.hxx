...
private:
    ...
    public:
         ...
         * postinit stage.
         * @param subaction Subaction to get module name for, or nullptr for all
         *                  subactions.
         */
    ...
    protected:
         ...
         * This is used for keeping track of actions in the action set, however
         * the actions refer back to this ActionSet in a loop so cleanup must be
         * explicit via cleanupActions().
         */
    ...
    public:
         ...
         * @param actionSet The osgXR action set
         * @param action    The osgXR part of this action.
         * @param node      Property node describing the action.
         */
        ActionCommon(osgXR::ActionSet* actionSet,
                     osgXR::Action* action,
                     SGPropertyNode* node);
        /// Destructor
         ...
         *                  subactions.
         * @return The SubactionInfo object for @a subaction, or nullptr if it
         *         doesn't exist (because it hasn't been defined as a possible
         *         subaction to filter actions by).
         */
         ...
         * classes to choose what SubactionInfo derived classes to create for
         * the action.
         * @param subaction  Subaction to create info for, or nullptr for all
         *                   subactions.
         * @param node       Property node describing the action.
         * @param statusNode Property node for describing the subaction status.
    ...
    public:
         ...
         * @param subaction Subaction this object relates to, or nullptr for all
         *                  subactions.
         * @param node      Property node describing the subaction, or nullptr
         *                  for all subactions.
         */
    ...
    public:
        ...
        ActionTyped(ActionSet* actionSet, SGPropertyNode* node)
            : XRAction(actionSet),
              ActionCommon(actionSet, this, node)
        {
        }
         ...
         *         hasn't been defined as a possible subaction to filter actions
         *         by).
         */
        SubactionInfo* getSubactionInfo(Subaction* subaction)
        {
    ...
    public:
         ...
         * @param input   VR input subsystem object.
         * @param manager VR manager object.
         * @param vendor  Vendor string forming first part of OpenXR interaction
         *                profile path.
         * @param type    Type string forming second part of OpenXR interaction
         *                profile path.
...
public:
    ...
    public:
         ...
         * @param node   Mode process object property node to get bindings from.
         * @param module Nasal module name.
         */
        virtual void postinit(SGPropertyNode* node,
                              const std::string& module) = 0;
