...
/**
 * @file
 * @brief A hot air balloon simulator
 */
...
void balloon::update()
{
    ...
    /*                                 cb                                   */
    /*                                                                      */
    /* On each center  are forces acting:  gravity and  wind resistance.  CE */
    /* additionally got the lift  (=> I need to calculate the weight of the */
    /* air inside, too)							    */
    /*                                                                      */
    /* The weight of the air  in the envelope is  dependent of the temperature */
    /* This temperature is decreasing over the time that is dependent */
    ...
    /*                                                                      */
    /* with 'l' being the 'length' i.e. thickness of the insulator, alpha1 */
    ...
    /* balloon consists only of the envelope.I will improve the simulation */
...
void balloon::getHPR(SGVec3f& angles) const //the balloon isn't always exactly vertical
{
    angles = hpr;
}
