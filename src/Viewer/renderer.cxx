...
FGRenderer::PickList handlePickIntersections(LineStripIntersections& intersections)
{
    FGRenderer::PickList result;
...
FGRenderer::PickList handlePickIntersections(osgUtil::PolytopeIntersector::Intersections& intersections)
{
    FGRenderer::PickList result;
...
FGRenderer::PickList FGRenderer::pick(const osg::Polytope& polytope)
{
...
FGRenderer::PickList handlePickIntersections(osgUtil::PlaneIntersector::Intersections& intersections)
{
    FGRenderer::PickList result;
...
FGRenderer::PickList FGRenderer::pick(const osg::Plane& plane,
